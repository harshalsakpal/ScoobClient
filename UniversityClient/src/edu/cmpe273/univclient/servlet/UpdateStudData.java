...
public class UpdateStudData extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		if (request.getParameter("hiddensjsuid") != null
				|| !"".equals(request.getParameter("hiddensjsuid"))) {
		...
		System.out.println("In update servlet gender is >>>"
				+ request.getParameter("gender"));
		if (request.getParameter("gender") != null
				|| !"".equals(request.getParameter("gender"))) {
			person.setGender(request.getParameter("gender"));
		}
		if (request.getParameter("dateOfBirth") != null
				|| !"".equals(request.getParameter("dateOfBirth"))) {
			person.setDateOfBirth(request.getParameter("dateOfBirth"));
		}
		if (request.getParameter("addrLine1") != null
				|| !"".equals(request.getParameter("addrLine1"))) {
			person.setAddrLine1(request.getParameter("addrLine1"));
		}
		if (request.getParameter("addrLine2") != null
				|| !"".equals(request.getParameter("addrLine2"))) {
			person.setAddrLine2(request.getParameter("addrLine2"));
		}
		if (request.getParameter("emailid") != null
				|| !"".equals(request.getParameter("emailid"))) {
		...
		if (request.getParameter("cityName") != null
				|| !"".equals(request.getParameter("cityName"))) {
		...
		System.out.println("In update servlet depart is >>>"
		...
		if (updateReply.equals("Update Success")) {
			System.out.println("In if of update success");
			session.setAttribute("instructorDetails", person);
