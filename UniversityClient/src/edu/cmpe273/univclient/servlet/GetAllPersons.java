...
/**
 * Servlet implementation class GetAllPersons
 */
public class GetAllPersons extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		System.out.println("In get All Persons servlet");
		...
		Person[] person = proxy.listAllPersons();
		session.setAttribute("listOfAllPersons", person);
		System.out.println("Listing All Persons");
		for (int iCount = 0; iCount < person.length; iCount++) {
				System.out.println("SJSU ID OF ALL Persons >> "+person[iCount].getSjsuid());
		}
		response.sendRedirect("view/ListAllPersons.jsp");
