		...
		<header class="row">
			<div class="span12">
					...
					<div class="well">
						...
						<div>
								<input type="button" class="btn btn-success" value="Delete Class" onclick=" return doContinue()">
						<br>
   ...
   <script src="<%request.getContextPath(); %>/js/bootstrap-select.js"></script>
 	...
 	function doContinue(){
		...
		if(section==null||section==""){
		   ...
		   document.forms[0].action = '../AdminDeleteClass';
	...
	function removeError() {
		...
		var course_number=document.forms[0].course_number.value; 
