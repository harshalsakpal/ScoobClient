...
<%
	...
	Person[] person = (Person[])session.getAttribute("listOfAllPersons");
%>
<!-- Bootstrap -->
...
<body>
	<div class="container control-group">
		<header class="row">
			<div class="span12">
				<div class="well">
					<form method="post" name="ListAllPersons">
						<div class="controls controls-row info">
							<input type="button" class="input-medium required span3"
								name="GetAllProfessors" value="Get All Persons"
								onclick="return getAllPersons()">
						</div>
				...
				<tr>
					...
					<td>Address Line 1</td><td>Address Line 2</td><td>Email ID</td><td>Date of Birth</td><td>Department</td><td>Role</td>
				</tr>	
